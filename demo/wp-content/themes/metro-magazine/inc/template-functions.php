...
function  metro_magazine_mobile_header(){
    ?>
    <div class="mobile-header" id="mobilemasthead" role="banner" itemscope itemtype="http://schema.org/WPHeader">
        <div class="container">
    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                echo '<a href="'. esc_url( __( 'https://raratheme.com/', 'metro-magazine' ) ) .'" rel="nofollow" target="_blank">'. esc_html__( 'Rara Theme', 'metro-magazine' ) . '</a>. ';
